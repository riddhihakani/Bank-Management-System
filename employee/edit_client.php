...
<?php 
    ...
    //echo '<small class="pull-left" style="color:#337ab7;">' . $_SESSION['user_data']['fname'] . ' | Editing Customer</small>';
...
if(isset($_POST['update_customer'])){
    ...
    $db->query('UPDATE customer SET fname=:fname, email=:email WHERE customer_id=:id');
